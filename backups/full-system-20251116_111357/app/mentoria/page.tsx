...
export default function MentoriaPage() {
  ...
  return (
    <AppLayout>
      <BenefitsGrid
        title="Beneficios de la Mentoría"
        subtitle="Todo lo que obtienes con nuestro programa de mentoría"
          ...
          <div className="bg-nodo-card border border-nodo-icon rounded-xl p-8">
            {success ? (
              <div className="text-center py-12">
                <div className="w-20 h-20 bg-emerald-500/20 border-2 border-emerald-500/50 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group relative w-full py-4 bg-gradient-to-r from-bitcoin-orange to-bitcoin-gold text-white font-bold text-lg rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-bitcoin-orange/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
