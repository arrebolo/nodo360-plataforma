...
- [ ] Arreglar el despliegue: producción corre desde `content/cold-storage-course`, no desde `main` — restaurar el flujo normal (deploy desde `main`)
...
- [ ] Commitear `docs/content/` (69 KB sin subir a git: guiones de Cold Storage, Nodos Bitcoin, guía de slides)
