    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/60">Inicia sesión para continuar aprendiendo</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="text-sm text-[#ff6b35] hover:text-[#f7931a] transition-colors"
              >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0a0a0a] text-white/40">o continúa con</span>
            </div>
          </div>
          ...
          <p className="mt-6 text-center text-white/60">
            ¿No tienes cuenta?{' '}
            <Link href="/registro" className="text-[#ff6b35] hover:text-[#f7931a] font-medium transition-colors">
              Regístrate gratis
            </Link>
          </p>
        </div>
