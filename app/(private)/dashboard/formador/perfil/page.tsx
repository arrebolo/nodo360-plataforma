        ...
        <div className="space-y-6">
          ...
          <section className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm text-gray-400 mb-2 block">Biografía</label>
                <textarea
                  value={bio}
                  onChange={(e) => setBio(e.target.value)}
                  placeholder="Cuéntanos sobre ti, tu experiencia y qué pueden esperar los alumnos…"
                  rows={5}
                  className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#f7931a]"
                />
              </div>
          ...
          <section className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm text-gray-400 mb-2 block">Precio por hora (créditos)</label>
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-gray-400">créditos/hora</span>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 pt-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="font-medium">Ofrecer sesión introductoria gratuita</span>
                ...
                {offersFreeIntro && (
                  <div className="mt-3 ml-8">
                    <label className="text-sm text-gray-400 mb-2 block">Duración de la intro gratis</label>
                    <select
