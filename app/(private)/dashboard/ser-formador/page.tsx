        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          {isPending ? (
            <>
              ...
              <h1 className="text-2xl font-bold mb-4">Solicitud en revisión</h1>
              <p className="text-gray-400 mb-6">
                Tu solicitud para ser instructor está siendo revisada por nuestro equipo.
            ...
            <>
              ...
              <p className="text-gray-400 mb-6">
                Tu cuenta de formador está actualmente suspendida.
    ...
    <div className="min-h-screen bg-[#070a10] text-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold">Conviértete en Instructor</h1>
        ...
        <div className="bg-gradient-to-r from-blue-900/30 to-cyan-900/30 border border-blue-500/30 rounded-xl p-6 mb-8">
          <h2 className="font-semibold text-blue-300 mb-3">Proceso de admisión</h2>
          <ol className="space-y-2 text-sm text-gray-300">
            <li className="flex items-start gap-2">
              ...
              <span>Completa este formulario con tu información y experiencia</span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>Nuestro equipo revisará tu solicitud (24-48 horas)</span>
            </li>
            <li className="flex items-start gap-2">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>Al aprobar, tu perfil de instructor se activará automáticamente</span>
            </li>
          </ol>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="¿Cómo quieres que te conozcan los alumnos?"
              ...
              <div>
                <label className="text-sm text-gray-400 mb-2 block">
                  Eslogan o tagline breve
                </label>
                <input
                  type="text"
                  value={tagline}
                  onChange={(e) => setTagline(e.target.value)}
                  placeholder="Ej: Experto en trading con 10 años de experiencia"
                  maxLength={100}
                  className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#f7931a]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Cuéntanos sobre tu trayectoria, experiencia y qué puedes ofrecer a los alumnos…"
                  rows={4}
                  className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#f7931a]"
                />
              </div>
          ...
          <section className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Selecciona hasta 3 áreas en las que te especializas
            </p>
          ...
          <section className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm text-gray-400 mb-2 block">
                  ¿Cuántos años de experiencia tienes en crypto/blockchain?
                </label>
                <select
                  value={experience}
              ...
              <div>
                <label className="text-sm text-gray-400 mb-2 block">
                  ¿Por qué quieres ser instructor en Nodo360?
                </label>
                <textarea
                  value={motivation}
                  onChange={(e) => setMotivation(e.target.value)}
                  placeholder="Cuéntanos tu motivación para enseñar y ayudar a otros…"
                  rows={3}
                  className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#f7931a]"
                />
              </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Me comprometo a mantener un comportamiento profesional, respetar las políticas de Nodo360,
                  y ofrecer sesiones de calidad a los alumnos. Entiendo que mi cuenta puede ser suspendida
                  si no cumplo con estos estándares.
                </p>
              </div>
            </label>
          </section>
        ...
        <div className="mt-12 p-6 bg-gradient-to-r from-amber-900/20 to-orange-900/20 border border-amber-500/30 rounded-xl">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-amber-300 mb-2">¿Qué es un Mentor?</h3>
              <p className="text-sm text-gray-300">
                Los Mentores son la élite de Nodo360. Son instructores que han demostrado
                un compromiso excepcional con la comunidad, acumulando puntos por su
                contribución, valoraciones sobresalientes y reconocimiento de sus alumnos.
              </p>
              <p className="text-sm text-gray-400 mt-2">
                Primero conviértete en instructor, y si destacas, podrás ser promocionado a Mentor.
              </p>
            </div>
          </div>
        </div>
