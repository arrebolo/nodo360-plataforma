...
async function getLeaderboard() {
  ...
  return data?.map((entry: any, index: number) => ({
    ...
    full_name: entry.users?.full_name || entry.users?.email?.split('@')[0] || 'Usuario',
                ...
                {leaderboard[2] && (
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl p-3 text-center min-w-[120px] shadow-xl border-2 border-amber-700/50">
                      <p className="text-2xl font-bold text-yellow-400 mb-1">#3</p>
                      <p className="text-white font-semibold mb-1 truncate">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="text-2xl">
                        ...
                        {!['lesson_completed', 'course_completed', 'badge_unlocked', 'level_up'].includes(activity.event_type) && '📝'}
                      </div>
                      <div>
