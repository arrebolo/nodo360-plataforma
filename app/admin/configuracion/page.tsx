...
import { Settings, Zap, TrendingUp, Bell, Shield, Database } from 'lucide-react'
...
async function getSystemConfig() {
  ...
  // En este ejemplo, asumimos que las configuraciones están en una tabla system_config
  // o las definimos por defecto si no existe la tabla

  // XP por acción (valores por defecto)
  const xpConfig = {
    lesson_completed: 50,
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
        <div className="bg-gradient-to-r from-[#ff6b35]/10 to-[#f7931a]/10 border-b border-white/10 p-6">
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-3 p-3 bg-white/5 rounded-lg cursor-not-allowed opacity-50">
              <input
                ...
                className="w-4 h-4 rounded bg-white/5 border-white/10"
              />
              <span className="text-sm text-gray-400">Modo mantenimiento</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
        <p className="text-sm text-blue-400">
          💡 <strong>Nota:</strong> Los cambios en la configuración de XP y niveles
          afectan el comportamiento del sistema de gamificación. Los cambios se
