      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/30">
            ...
            <p className="text-xs text-gray-400">En Votación</p>
          </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="text-lg font-semibold group-hover:text-[#ff6b35] transition-colors truncate text-white">
                        {proposal.title}
                      </h3>
...
function FilterButton({
  ...
  const colors = {
    gray: active ? 'bg-white/20 text-white' : 'bg-white/5 text-gray-400 hover:bg-white/10',
    yellow: active ? 'bg-yellow-500/30 text-yellow-400' : 'bg-white/5 text-gray-400 hover:bg-yellow-500/10',
    blue: active ? 'bg-blue-500/30 text-blue-400' : 'bg-white/5 text-gray-400 hover:bg-blue-500/10',
    green: active ? 'bg-green-500/30 text-green-400' : 'bg-white/5 text-gray-400 hover:bg-green-500/10',
    red: active ? 'bg-red-500/30 text-red-400' : 'bg-white/5 text-gray-400 hover:bg-red-500/10',
    purple: active ? 'bg-purple-500/30 text-purple-400' : 'bg-white/5 text-gray-400 hover:bg-purple-500/10',
  }
